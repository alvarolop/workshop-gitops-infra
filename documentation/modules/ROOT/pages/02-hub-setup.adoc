...
You can take a look to the chart used for creating these secrets https://github.com/romerobu/workshop-gitops-content-deploy/blob/setup-sno/hub-setup/charts/gitops-setup/values.yaml[here] and https://github.com/romerobu/workshop-gitops-content-deploy/blob/setup-sno/hub-setup/charts/gitops-setup/templates/secret-cluster.yaml[here].
